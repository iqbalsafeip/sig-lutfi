...
$this->title = 'PUPR SIG Jalan Garut';
?>

        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="#page-top">PUPR Kabupaten Garut</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#download">Data Jalan</a></li>
                    </ul>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">SIG Pendataan Data Dasar Jalan <br>Kab. Garut</h1>
                    ...
                    <div class="col-lg-6">
                        <img class="app-badge ml-4" style="max-width: 80%; height: 80%" src="<?= Yii::getAlias('@web') . "/img/bg.svg" ?>" alt="..." />
                    </div>
                </div>
            </div>
        </header>
